<template>
  <main>
    <div class="header">
      <h5 class="text-bold">Kindle Book offers for you</h5>
    </div>

    <vue-horizontal responsive scroll class="horizontal">
      <div class="item" :key="1">
        <div class="card">
          <div class="content">
            <div>
              <img src="~assets/R7P1.jpg" alt="Nothing there" />
            </div>
          </div>
        </div>
      </div>
      <div class="item" :key="1">
        <div class="card">
          <div class="content">
            <div>
              <img src="~assets/R7P2.jpg" alt="Nothing there" />
            </div>
          </div>
        </div>
      </div>
      <div class="item" :key="1">
        <div class="card">
          <div class="content">
            <div>
              <img src="~assets/R7P3.jpg" alt="Nothing there" />
            </div>
          </div>
        </div>
      </div>
      <div class="item" :key="1">
        <div class="card">
          <div class="content">
            <div>
              <img src="~assets/R7P4.jpg" alt="Nothing there" />
            </div>
          </div>
        </div>
      </div>
      <div class="item" :key="1">
        <div class="card">
          <div class="content">
            <div>
              <img src="~assets/R7P5.jpg" alt="Nothing there" />
            </div>
          </div>
        </div>
      </div>
      <div class="item" :key="1">
        <div class="card">
          <div class="content">
            <div>
              <img src="~assets/R7P6.jpg" alt="Nothing there" />
            </div>
          </div>
        </div>
      </div>
      <div class="item" :key="1">
        <div class="card">
          <div class="content">
            <div>
              <img src="~assets/R7P7.jpg" alt="Nothing there" />
            </div>
          </div>
        </div>
      </div>
      <div class="item" :key="1">
        <div class="card">
          <div class="content">
            <div>
              <img src="~assets/R7P8.jpg" alt="Nothing there" />
            </div>
          </div>
        </div>
      </div>
      <div class="item" :key="1">
        <div class="card">
          <div class="content">
            <div>
              <img src="~assets/R7P9.jpg" alt="Nothing there" />
            </div>
          </div>
        </div>
      </div>
      <div class="item" :key="1">
        <div class="card">
          <div class="content">
            <div>
              <img src="~assets/R7P10.jpg" alt="Nothing there" />
            </div>
          </div>
        </div>
      </div>
      <div class="item" :key="1">
        <div class="card">
          <div class="content">
            <div>
              <img src="~assets/R7P11.jpg" alt="Nothing there" />
            </div>
          </div>
        </div>
      </div>
      <div class="item" :key="1">
        <div class="card">
          <div class="content">
            <div>
              <img src="~assets/R7P12.jpg" alt="Nothing there" />
            </div>
          </div>
        </div>
      </div>
      <div class="item" :key="1">
        <div class="card">
          <div class="content">
            <div>
              <img src="~assets/R7P13.jpg" alt="Nothing there" />
            </div>
          </div>
        </div>
      </div>
      <div class="item" :key="1">
        <div class="card">
          <div class="content">
            <div>
              <img src="~assets/R7P14.jpg" alt="Nothing there" />
            </div>
          </div>
        </div>
      </div>
      <div class="item" :key="1">
        <div class="card">
          <div class="content">
            <div>
              <img src="~assets/R7P15.jpg" alt="Nothing there" />
            </div>
          </div>
        </div>
      </div>
    ...
    <q-card class="q-mt-lg">
      <q-img src="~assets/Hero2.png"></q-img>
    </q-card>
  </main>
</template>
